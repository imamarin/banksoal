                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <select name="kdguru" class="select2" style="position: relative;z-index: 100000000;" data-placeholder="Pilih Siswa" data-dropdown-css-class="select2-blue" style="width: 100%;" required="">
                                                                <option>1</option>
                                                                <option>2</option>
                                                                {{-- <?php
